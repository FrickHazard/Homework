...
begin
 calc b = 1 * b         : by rw one_mul
    ...
    ... = a⁻¹ * (a * b) : by rw mul_assoc a⁻¹ a b
    ... = a⁻¹ * (a * c) : by rw Habac
    ... = (a⁻¹ * a) * c : by rw ←mul_assoc a⁻¹ a c
...
begin
  ...
  exact eq.symm (mul_left_inv a)
end

@[simp] theorem mul_right_inv : a * a⁻¹ = 1 :=
begin
  apply mul_eq_of_eq_inv_mul,
  exact eq.symm (mul_one a⁻¹)
end
...
begin
  calc
    a ⁻¹ ⁻¹ = a ⁻¹ ⁻¹ * 1  : by rw mul_one
    ... = a ⁻¹ ⁻¹ * a ⁻¹ * a  : by rw [←mul_left_inv, mul_assoc]
...
begin
  exact eq.symm (inv_eq_of_mul_eq_one h),
end
...
begin
  ...
  calc
    a = a * 1 :by rw mul_one
    ... = a * (b⁻¹ * b) : by rw mul_left_inv
    ... = (a * b⁻¹) * b : by rw mul_assoc
    ... = (a * a⁻¹) * b : by rw h
    ... = 1 * b : by rw mul_right_inv
    ... = b : by rw one_mul,
  intro h,
  -- same as above but using right
  calc
    a⁻¹ = a⁻¹ * 1 :by rw mul_one
