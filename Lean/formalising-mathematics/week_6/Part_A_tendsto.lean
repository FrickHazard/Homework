...
begin
  ...
  {
    intros h fs fs_in_image_s,
    rcases fs_in_image_s with ⟨x, ⟨xinS, fx_eq_fs⟩ ⟩,
    rw ←fx_eq_fs,
    exact h xinS,
  },
end
...
{ sets := {T : set Y | f ⁻¹' T ∈ F },
  ...
  sets_of_superset := begin
    intros set1 set2 set1Prop set1_sb_set2,
    apply mem_sets_of_superset set1Prop,
    intros x hx,
    exact set1_sb_set2 hx,
  end,
  inter_sets := begin
    intros set1 set2 set1Prop set2Prop,
    exact inter_mem_sets set1Prop set2Prop,
  end, }
...
{ sets := {S : set X | ∃ T ∈ G, f ⁻¹' T ⊆ S},
  ...
  sets_of_superset := begin
    intros set1 set2 set1Prop set1_sb_set2,
    rcases set1Prop with ⟨setY, ⟨setYinG, fsbst⟩⟩,
    use setY,
    constructor,
    { assumption },
    { exact subset.trans fsbst set1_sb_set2 },
  end,
  inter_sets := begin
    intros set1 set2 set1Prop set2Prop,
    rcases set1Prop with ⟨set1Y, ⟨set1YinG, h1⟩⟩,
    rcases set2Prop with ⟨set2Y, ⟨set2YinG, h2⟩⟩,
    have: set1Y ∩ set2Y ∈ G, {
      exact inter_mem_sets set1YinG set2YinG,
    },

    constructor, {
      use this,
      intros x xinInt,
      cases xinInt with fxset1 fxset2,
      constructor, {
        exact h1 fxset1,
      }, {
        exact h2 fxset2,
...
begin
  ...
  split, {
    intro h,
    rcases h with ⟨set1,  set1inG, revImg⟩,
    dsimp at revImg,
    exact mem_sets_of_superset set1inG revImg,
  }, {
    intro h,
    use y,
    constructor, {
...
begin
  ...
  split, {
    intro h,
    rcases h with ⟨setZ, ⟨setZinH, hgf⟩ ⟩ ,
    use g ⁻¹' setZ,
    constructor, {
      use setZ,
      constructor,
  ...
  {
    intro h,
    rcases h with ⟨setY, ⟨⟨setZ, ⟨hsetZ, hh⟩⟩, hhh ⟩⟩,
    use setZ,
    constructor,
    { assumption},
    {
...
begin
  ...
  split, {
    ...
    rcases h with ⟨setY, setYinP, hsb⟩,
    rw mem_principal_sets at setYinP,
    intros h hinT,
    exact hsb (setYinP hinT),
  }, {
    intro h,
...
begin
  split, {
    intros h setX setXinCofg,
    rcases setXinCofg with ⟨setY, setYinG, hsb⟩,
    exact  mem_sets_of_superset (h setYinG) hsb,
  },{
    intros h g ginG,
    apply h,
    use [g, ginG],
